...
/**
 * Created by liujian on 2018/8/17.
 */

public class FriendStatusPublishActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(FriendStatusPublishActivity.this, 4, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(FriendStatusPublishActivity.this, onAddPicClickListener);
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            PictureSelector.create(FriendStatusPublishActivity.this)
    ...
    private void uploadVideo(File file){
        ...
        new UploadApi().uploadVideo(files, new INetWorkCallback<UploadVideoResultDO>() {
            ...
            public void failure(int errorCode, String message) {
                showProcessDialog(false);
                Toast.makeText(FriendStatusPublishActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
